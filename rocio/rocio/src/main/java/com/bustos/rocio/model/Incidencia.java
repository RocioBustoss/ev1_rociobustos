...
public class Incidencia {
    ...
    @Positive(message = "El nivel de prioridad debe ser positivo")
    ...
    public Incidencia (String descripcion, String estado, int nivelPrioridad, String usuario, LocalDateTime fechaRegistro){
